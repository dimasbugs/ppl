					...
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
			      		...
			      		<div class="form-group mb-3">
                            <input type="hidden" class="form-control" name="id" id="id" placeholder="Username" required value="<?=$adm["id"]?>">
                            <input type="hidden" name="gambarlama" id="gambarlama" value="<?=$adm["gambar"];?>">
