	...
	<section class="ftco-section">
        ...
        <h3 class="mb-4"><a href="akun.php">Kembali</a></h3>
				...
				<div class="form-group mb-3">
						...
						<input type="text" class="form-control" name="perusahaan" id="perusahaan" placeholder="perusahaan" required value="<?=$adm["perusahaan"]?>">
					</div>
				<div class="form-group mb-3">
						<label class="label" for="tanggallahir">Tanggal Lahir</label>
						<input type="text" class="form-control" name="tanggallahir" id="tanggallahir" placeholder="tanggallahir" required value="<?=$adm["tanggallahir"]?>">
					</div>
